...
function DummyFill() {
    document.getElementById("writer").innerHTML = `<p>
                Just over two months later, an attempt on his life would be made and failed. He quickly recovered and
                returned to duty,
                and this caused his popularity to sky rocket. At the end of his presidency, he left with an approval
                rating of 60%,
                the third highest for a departing president in history, behind only Franz D. roosevelt and Bill
                <span class="spell"
                    data-tooltip="Possible capitalization / proper noun: consider “Clinton”.">clinton</span>,
                both having 66%.
            </p>

            <p>
                In conclusion, Brutus strongly though that caeser was a bad leader, which is why he was apart of his
                death.
                <span class="hl hlTip"
                    data-tooltip="Run-on sentence: consider splitting, adding punctuation, or restructuring.">
                    Brutus's speech in Act 3, scene 2 of "Julius Ceaser" made it clear that he supposedly loved Ceaser,
                    but he loved Rome more, and asked the people would they rather Ceaser be alive and the people die a
                    slaves or
                    Ceaser be dead and the be they die free independent people.
                </span>
                <span class="hl hlTip"
                    data-tooltip="Clarity/logic: consider revising for readability and tightening phrasing.">
                    Brutus believed that he would be a better leader than Ceaser, but the question is if Brutus is
                    willing to murder
                    someone just because he thought he was a better leader and wanted the throne, then why would he not
                    do it again
                    to anyone who stands in his way?
                </span>
                <span class="hl hlTip"
                    data-tooltip="Tone: rhetorical question is fine, but you can shorten for impact.">
                    Do you really want someone who is potentially going to cause more deaths than freedom and equality?
                </span>
            </p>`;
}