...
vector<size_t> WordPieceTokenizer::tokenize_full(const wstring& input_text) {
    ...
    for (size_t i = 0; i < tokens.size(); i++) {
        ...
        basic_tokenized.insert(
            basic_tokenized.end(), splitted_by_punc.begin(), splitted_by_punc.end());
    }
    ...
    for (size_t i = 0; i < basic_tokenized.size(); i++) {
        ...
        wordpiece_tokenized.insert(
            wordpiece_tokenized.end(), splitted_by_wordpiece.begin(), splitted_by_wordpiece.end());
    }
