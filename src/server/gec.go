...
/*
#cgo CFLAGS:  -I${SRCDIR}/../gec
#cgo LDFLAGS: ${SRCDIR}/../gec/libgec.a -lstdc++ -lm -ldl -ljson-c -lsentencepiece -licuuc -licudata -lonnxruntime -lonnxruntime_providers_shared -lonnxruntime_providers_cuda -lcuda
#include "inference.h"
*/
import "C"
import (
